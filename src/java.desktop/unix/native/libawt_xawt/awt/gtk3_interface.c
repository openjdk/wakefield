...
//        fp_g_dbus_proxy_new_for_bus_sync = dl_symbol("g_dbus_proxy_new_for_bus_sync");
        ...
        fp_g_file_get_contents = dl_symbol("g_file_get_contents");
        fp_g_file_set_contents_full = dl_symbol("g_file_set_contents_full");
...
static void gtk3_init(GtkApi* gtk) {
    ...
    gtk->g_dbus_proxy_get_connection = fp_g_dbus_proxy_get_connection;
    ...
    gtk->g_variant_iter_free = fp_g_variant_iter_free;
    ...
    gtk->g_string_new_len = fp_g_string_new_len;
    gtk->g_string_erase = fp_g_string_erase;
    gtk->g_string_set_size = fp_g_string_set_size;
    gtk->g_string_append = fp_g_string_append;
    gtk->g_string_free = fp_g_string_free;
    gtk->g_string_assign = fp_g_string_assign;
    ...
    gtk->g_file_get_contents = fp_g_file_get_contents;
    gtk->g_file_set_contents_full = fp_g_file_set_contents_full;
}
